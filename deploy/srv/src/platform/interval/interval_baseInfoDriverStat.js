...
const fn_setbaseInfoDriverStat = (updateddata,callbackfn)=>{
  ...
  queryexec.exec((err,driverinfo)=>{
    if(!err && !!driverinfo){
      ...
      dbModel.findOneAndUpdate({LicenseId:updateddata.LicenseId,Cycle:updateddata.Cycle},
        {
          $set:updateddata
        },{
          new:true,
...
const interval_baseInfoDriverStat = ()=>{
  ...
  //   TrafficViolationCount:Number,//		是	数字型V32	交通违章次数
