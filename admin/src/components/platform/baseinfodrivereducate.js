       ...
       <Create {...props} title={<BaseInfoDriverEducatecreateTitle />} >
           <SimpleForm>
             <ReferenceInput label="平台关联司机" source="Platform_baseInfoDriverId" reference="baseinfodriver" allowEmpty perPage={200}>
               ...
               <DateInputString label="培训开始时间" source="StartTime" validate={[required]} defaultValue={'09:00'}/>
               <DateInputString label="培训结束时间" source="StopTime"  validate={[required]} defaultValue={'11:00'}/>
