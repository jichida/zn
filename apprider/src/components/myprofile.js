...
export class Page extends React.Component {
  ...
  <div style={{
    ...
    <li className="item item-linked" onClick={this.onClickItem.bind(this,'/oftenuseaddress')}><a>
    <div className="item-media"><span className="icon icon-add"></span></div>
    <h3 className="item-title padding-left">常用地址</h3>
      <span className="icon icon-right-nav item-icon"></span></a>
        ...
        <li className="item item-linked" onClick={this.onClickItem.bind(this,'/mycoupon')}><a>
        <div className="item-media"><span className="icon icon-yhj"></span></div>
        <h3 className="item-title padding-left">我的优惠券</h3>
        <span className="icon icon-right-nav item-icon"></span></a></li>

        <li className="item item-linked"  onClick={this.onClickItem.bind(this,'/systemsettings')}><a>
    ...
    <div className="group text-center margin-bottom-0"><img src="images/logo_foot.png" alt='footer'/></div>
