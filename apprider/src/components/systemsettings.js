  ...
  return (<View>
	   <NavBar {...dataLeft}/>
        ...
        <div className="group group-no-padded margin-top-0">
          ...
          <div className="group-body">
		  <ul className="list">
              <li  onClick={this.onClickPage.bind(this,'/about/rideruserguide')} className="item item-linked"><a><div className="item-media"><span className="icon icon-gz"></span></div>
                <div className="item-main"><h3 className="item-title">用户指南</h3>
                <span className="icon icon-right-nav item-icon"></span></div></a></li>
              <li  onClick={this.onClickPage.bind(this,'/about/riderfeerules')}  className="item item-linked"><a><div className="item-media"><span className="icon icon-jfgz"></span></div>
                <div className="item-main"><h3 className="item-title">计费规则</h3>
                <span className="icon icon-right-nav item-icon"></span></div></a></li>
                <li onClick={this.onClickPage.bind(this,'/about/riderlaws')}   className="item item-linked"><a><div className="item-media"><span className="icon icon-flfg"></span></div>
