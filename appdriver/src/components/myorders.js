        ...
        return (
            <View>
                <header className="navbar">
                    ...
                    <div onClick={this.onClickBack.bind(this)} className="navbar-nav navbar-left">
                    <a className="navbar-nav-item"><span className="icon icon-left-nav navbar-icon navbar-icon-sibling-of-title">返回</span></a>
                    </div>
                </header>
